       ...
       <form className=" m-3 p-3 w-290 bg-white-900">
            ...
            <div className="flex items-center">
                    ...
                    <div className="  bg-white mt-4 flex justify-items-start  rounded-md ">
                        ...
                        <button type="button" disabled={quantity >= 20} onClick={increment} className="  rounded-md w-10 h-10 bg-green-300 m-2 "> + </button>

                        <button type="button" disabled={quantity <= 1} onClick={decrement} className="bg-red-400  rounded-md w-10 h-10  m-2"> - </button>
                    </div>
